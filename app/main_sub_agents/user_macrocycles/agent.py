...
from app.main_sub_agents.base_sub_agents.base import confirm_impact, determine_if_create, determine_if_alter, determine_if_read
...
class SubAgent(BaseAgent):
    ...
    def create_main_agent_graph(self, state_class):
        ...
        workflow.add_edge("creation_agent", "operation_is_not_alter")
