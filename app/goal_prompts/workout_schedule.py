...
workout_schedule_request = {
    "description": """**Workout Schedule** - Level where the specific exercise is a workout for a day is determined. Specific exercise-level requests within a workout (e.g., changing exercises, sets, reps, or focus).""", 
