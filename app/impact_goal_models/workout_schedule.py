...
class WorkoutScheduleGoalPart(BaseModel):
...
class WorkoutScheduleGoal(WorkoutScheduleGoalPart):
    other_requests: Optional[str] = Field(
        None, description="All information and requests not immedately relevant to the workout schedule requests."
    )