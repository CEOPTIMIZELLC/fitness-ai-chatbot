...
def setup_params_node(state: State, config=None) -> dict:
    ...
    parameters = {
        ...
        "phase_components": [
            {'workout_component_id': 365, 'workout_day_id': 60, 'bodypart_id': 1, 'bodypart_name': 'total_body', 'duration': 90, 'duration_min': 30, 'duration_max': 90, 'phase_component_id': 1, 'phase_name': 'Stabilization Endurance', 'component_name': 'Flexibility', 'sub_component': 'flexibility-stabilization', 'reps_min': 1, 'reps_max': 1, 'sets_min': 1, 'sets_max': 3, 'tempo': '30 s hold', 'seconds_per_exercise': 30, 'intensity_min': None, 'intensity_max': None, 'rest_min': 0, 'rest_max': 0, 'exercises_per_bodypart_workout_min': None, 'exercises_per_bodypart_workout_max': None, 'exercise_selection_note': 'SMR and static'},
            {'workout_component_id': 366, 'workout_day_id': 60, 'bodypart_id': 1, 'bodypart_name': 'total_body', 'duration': 416, 'duration_min': 114, 'duration_max': 3680, 'phase_component_id': 2, 'phase_name': 'Stabilization Endurance', 'component_name': 'Core', 'sub_component': 'core-stabilization', 'reps_min': 12, 'reps_max': 20, 'sets_min': 1, 'sets_max': 4, 'tempo': 'Slow 4/2/1', 'seconds_per_exercise': 7, 'intensity_min': None, 'intensity_max': None, 'rest_min': 30, 'rest_max': 90, 'exercises_per_bodypart_workout_min': 1, 'exercises_per_bodypart_workout_max': 4, 'exercise_selection_note': None},
            {'workout_component_id': 367, 'workout_day_id': 60, 'bodypart_id': 1, 'bodypart_name': 'total_body', 'duration': 414, 'duration_min': 144, 'duration_max': 1188, 'phase_component_id': 5, 'phase_name': 'Stabilization Endurance', 'component_name': 'SAQ', 'sub_component': 'SAQ-strength', 'reps_min': 2, 'reps_max': 3, 'sets_min': 1, 'sets_max': 2, 'tempo': 'Moderate', 'seconds_per_exercise': 3, 'intensity_min': None, 'intensity_max': None, 'rest_min': 30, 'rest_max': 90, 'exercises_per_bodypart_workout_min': 4, 'exercises_per_bodypart_workout_max': 6, 'exercise_selection_note': 'drills with limited horizontal inertia and unpredictability'},
            {'workout_component_id': 368, 'workout_day_id': 60, 'bodypart_id': 3, 'bodypart_name': 'back', 'duration': 416, 'duration_min': 114, 'duration_max': 1380, 'phase_component_id': 6, 'phase_name': 'Stabilization Endurance', 'component_name': 'Resistance', 'sub_component': 'resistance-stabilization', 'reps_min': 12, 'reps_max': 20, 'sets_min': 1, 'sets_max': 3, 'tempo': 'Slow 4/2/1', 'seconds_per_exercise': 7, 'intensity_min': 50, 'intensity_max': 70, 'rest_min': 30, 'rest_max': 90, 'exercises_per_bodypart_workout_min': 1, 'exercises_per_bodypart_workout_max': 2, 'exercise_selection_note': 'stabilization progression'},
            {'workout_component_id': 369, 'workout_day_id': 60, 'bodypart_id': 4, 'bodypart_name': 'shoulders', 'duration': 416, 'duration_min': 114, 'duration_max': 1380, 'phase_component_id': 6, 'phase_name': 'Stabilization Endurance', 'component_name': 'Resistance', 'sub_component': 'resistance-stabilization', 'reps_min': 12, 'reps_max': 20, 'sets_min': 1, 'sets_max': 3, 'tempo': 'Slow 4/2/1', 'seconds_per_exercise': 7, 'intensity_min': 50, 'intensity_max': 70, 'rest_min': 30, 'rest_max': 90, 'exercises_per_bodypart_workout_min': 1, 'exercises_per_bodypart_workout_max': 2, 'exercise_selection_note': 'stabilization progression'},
            {'workout_component_id': 370, 'workout_day_id': 60, 'bodypart_id': 5, 'bodypart_name': 'biceps', 'duration': 416, 'duration_min': 114, 'duration_max': 1380, 'phase_component_id': 6, 'phase_name': 'Stabilization Endurance', 'component_name': 'Resistance', 'sub_component': 'resistance-stabilization', 'reps_min': 12, 'reps_max': 20, 'sets_min': 1, 'sets_max': 3, 'tempo': 'Slow 4/2/1', 'seconds_per_exercise': 7, 'intensity_min': 50, 'intensity_max': 70, 'rest_min': 30, 'rest_max': 90, 'exercises_per_bodypart_workout_min': 1, 'exercises_per_bodypart_workout_max': 2, 'exercise_selection_note': 'stabilization progression'},
            {'workout_component_id': 371, 'workout_day_id': 60, 'bodypart_id': 6, 'bodypart_name': 'triceps', 'duration': 416, 'duration_min': 114, 'duration_max': 1380, 'phase_component_id': 6, 'phase_name': 'Stabilization Endurance', 'component_name': 'Resistance', 'sub_component': 'resistance-stabilization', 'reps_min': 12, 'reps_max': 20, 'sets_min': 1, 'sets_max': 3, 'tempo': 'Slow 4/2/1', 'seconds_per_exercise': 7, 'intensity_min': 50, 'intensity_max': 70, 'rest_min': 30, 'rest_max': 90, 'exercises_per_bodypart_workout_min': 1, 'exercises_per_bodypart_workout_max': 2, 'exercise_selection_note': 'stabilization progression'},
            {'workout_component_id': 372, 'workout_day_id': 60, 'bodypart_id': 7, 'bodypart_name': 'legs', 'duration': 416, 'duration_min': 114, 'duration_max': 1380, 'phase_component_id': 6, 'phase_name': 'Stabilization Endurance', 'component_name': 'Resistance', 'sub_component': 'resistance-stabilization', 'reps_min': 12, 'reps_max': 20, 'sets_min': 1, 'sets_max': 3, 'tempo': 'Slow 4/2/1', 'seconds_per_exercise': 7, 'intensity_min': 50, 'intensity_max': 70, 'rest_min': 30, 'rest_max': 90, 'exercises_per_bodypart_workout_min': 1, 'exercises_per_bodypart_workout_max': 2, 'exercise_selection_note': 'stabilization progression'},
        ]
    }
...
def format_solution_node(state: State, config=None) -> dict:
    ...
    longest_subcomponent_string_size = len(max(phase_components[1:], key=lambda d:len(d["sub_component"]))["sub_component"])
    ...
    if solution is None:
        ...
        for component_count, (exercise_index, phase_component_index, 
            ...
            phase_component_name = phase_component["sub_component"] + " " + phase_component["bodypart_name"] 
        ...
        for phase_component_index, phase_component_number in enumerate(phase_component_count):
            phase_component = phase_components[phase_component_index]
            formatted += f"\t{phase_component["sub_component"] + " " + phase_component["bodypart_name"]:<{longest_string_size+3}}: {phase_component_number}\n"
