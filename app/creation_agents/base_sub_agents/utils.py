...
def new_input_request(user_input, item_system_prompt, item_goal):
    LogCreationAgent.system_message(item_system_prompt)
    ...
    LogCreationAgent.parsed_goal(f"Parsed Goal Fields: ")
    for key, value in goal_dict.items():
        LogCreationAgent.parsed_goal(f"{key}: {value}")
    LogCreationAgent.parsed_goal(f"")
