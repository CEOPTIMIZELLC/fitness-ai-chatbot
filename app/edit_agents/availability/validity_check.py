...
def add_local_bounds_violation(violations, item, value_name, min_value, max_value):
...
def check_schedule_validity(schedule_list):
    ...
    for schedule_item in schedule_list:
        ...
        add_local_bounds_violation(violations, schedule_item, "availability", min_availability, max_availability)
